...
Ссылка на контест: https://www.kaggle.com/competitions/final-contest-vk-ir-fall-2024
...
- создадите в своем форке новую ветку для своего решения, можете назвать ее например _homework-13-final-project_ (но подойдет и любое другое название на ваш вкус)
...
Ожидается, что вы:
- Создадите виртуальное окружение, например в папке _.venvs/homework-13-final-project_ в корне счекаученного на вашу локальную машину вашего форка репы курса
...
Скрипт будет запускаться вот так: `./solution.py --submission_file=submission.csv final-contest-vk-ir-fall-2024
...
- _final-contest-vk-ir-fall-2024_ -- это путь к папке с данными контеста (т.е. это те самые данные, которые можно скачать с Kaggle командой `kaggle competitions download -c final-contest-vk-ir-fall-2024`)
